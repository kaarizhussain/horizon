...
STEP 5 — Send the weekly review to Discord via send-msg (same curl pattern as the daily task, temp-file payload, X-Horizon-Key header). Under 1800 chars, Discord markdown:
